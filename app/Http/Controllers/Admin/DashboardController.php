...
class DashboardController extends Controller
{
    ...
    public function __construct(PropositionRepository $propositionRepository, VoterRepository $voterRepository)
    {
    ...
    public function index(): View
    {
        $propositions = $this
            ...
            ->findAll(['options', 'answers']);
        $voterCount = $this
            ->voterRepository
            ->aggregateVoterStatistics();
